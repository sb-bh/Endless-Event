...
$sel=mysql_query("select bname from band where bname='$bname' ");
$arr=mysql_fetch_array($sel);

if($arr['bname']!=$bname)
 {
   if(mysql_query("INSERT INTO band(bname,brate) values('$bname','$brate')"))
	   {
	      
	     echo "<html><script language='JavaScript'>alert('Band details is added succesfully.')</script></html>";
	echo "<script>location.href='addband.php'</script>";
	   }
	 }
else 
{
echo "<html><script language='JavaScript'>alert('Band details is exists')</script></html>";
	echo "<script>location.href='addband.php'</script>";
}
}
...
<body>
	...
	<div id="header">
		...
		<div>
			...
			<li class="current"><a href="addband.php">Add Band</a></li>
...
<table width=60% border="1" align="center">
  ...
  <tr>
    <td width="164"><div align="center"><font size="+1" face="Rockwell"><b>Name of Band</b></font></div></td>
    <td width="192">
